...
Those commands are already pasted in this script from the official web site, but when you execute the script you have to choose which package manager you are using and and which channel to use (Stable or Dev).
